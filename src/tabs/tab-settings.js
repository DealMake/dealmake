module.exports = function () {
    ...
    this.properties = {
        TAB_NAME: "Settings",
        TAB_ICON: _i("resources/images/tab-settings.png"),
        TAB_ICON_SELECTED: _i("resources/images/tab-settings.png"),
        TOOLBAR_SHOW: true,
        TABFOLDER_SHOW: true,
    ...
    this.initiateUI = function (app) {
        ...
        // Create a settings page and append it to the navigation view.
        var page = new this.app.PageSettings();
