module.exports = function () {
    ...
    this.properties = {
        TAB_NAME: "Messages",
        TAB_ICON: _i("resources/images/tab-messages.png"),
        TAB_ICON_SELECTED: _i("resources/images/tab-messages.png"),
        TOOLBAR_SHOW: true,
        TABFOLDER_SHOW: true,
    ...
    this.initiateUI = function (app) {
        ...
        // Create a messages page and append it to the navigation view.
        var page = new this.app.PageMessages();
