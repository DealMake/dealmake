module.exports = function () {
    ...
    this.properties = {
        ...
        TAB_ICON: _i("resources/images/tab-notifications.png"),
        TAB_ICON_SELECTED: _i("resources/images/tab-notifications.png"),
        TOOLBAR_SHOW: true,
        TABFOLDER_SHOW: true,
    ...
    this.initiateUI = function (app) {
        ...
        // Create a notifications page and append it to the navigation view.
        var page = new this.app.PageNotifications();
