module.exports = function () {
    ...
    this.initiateUI = function (tab) {
                            ...
                            if (index <= 0) {
                                ...
                                cell.find("#main").find("#delete").on("tap", function () {
                                    ...
                                    (new tabris.AlertDialog({
                                        ...
                                        xhr.open("POST", "http://deal-make.com/api/v1/users/" + that.tab.app.user + "/ventures/" + that.page.data.ventures[index - 1].ind + "/delete?token=" + that.tab.app.token);
        ...
        xhr.open("GET", "http://deal-make.com/api/v1/users/" + this.tab.app.user + "/ventures?token=" + this.tab.app.token);
        xhr.setRequestHeader("content-type", "application/json");
        xhr.setRequestHeader("cache-control", "no-cache");
        xhr.send();
    };
