// Type definitions for Tabris.js 2.1.0
...
export class ActionSheet extends Popup {
  ...
  public constructor(properties?: ActionSheetProperties);
   ...
   * @param properties 
   */
  set(properties: ActionSheetProperties): this;
}
...
export class Popup extends NativeObject {
   ...
   * @param properties 
   */
  set(properties: PopupProperties): this;
}
...
interface CollectionViewEvents extends WidgetEvents {
   ...
   */
  cellTypeChanged?: (event: PropertyChangedEvent<CollectionView, string|((index: number) => string)>) => void;
...
export class NavigationBar extends Widget {
  ...
  private constructor(properties?: NavigationBarProperties);
...
export class StatusBar extends Widget {
  ...
  private constructor(properties?: StatusBarProperties);
...
interface TextInputEvents extends WidgetEvents {
   ...
   */
  autoCapitalizeChanged?: (event: PropertyChangedEvent<TextInput, boolean>) => void;
