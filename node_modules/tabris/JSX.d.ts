...
interface CollectionViewEvents extends WidgetEvents {
   ...
   */
  onCellTypeChanged?: (event: tabris.PropertyChangedEvent<tabris.CollectionView, string|((index: number) => string)>) => void;
...
interface TextInputEvents extends WidgetEvents {
   ...
   */
  onAutoCapitalizeChanged?: (event: tabris.PropertyChangedEvent<tabris.TextInput, boolean>) => void;
...
declare namespace JSX {
  ...
  interface IntrinsicElements {
    actionSheet: tabris.ActionSheetProperties & ActionSheetEvents
    alertDialog: tabris.AlertDialogProperties & AlertDialogEvents
    app: tabris.AppProperties & AppEvents
    device: tabris.DeviceProperties & DeviceEvents
    fileSystem: tabris.FileSystemProperties & FileSystemEvents
    inactivityTimer: tabris.InactivityTimerProperties & InactivityTimerEvents
    nativeObject: tabris.NativeObjectProperties & NativeObjectEvents
    popup: tabris.PopupProperties & PopupEvents
    uI: tabris.UIProperties & UIEvents
    action: tabris.ActionProperties & ActionEvents
    activityIndicator: tabris.ActivityIndicatorProperties & ActivityIndicatorEvents
    button: tabris.ButtonProperties & ButtonEvents
    canvas: tabris.CanvasProperties & CanvasEvents
    checkBox: tabris.CheckBoxProperties & CheckBoxEvents
    collectionView: tabris.CollectionViewProperties & CollectionViewEvents
    composite: tabris.CompositeProperties & CompositeEvents
    drawer: tabris.DrawerProperties & DrawerEvents
    imageView: tabris.ImageViewProperties & ImageViewEvents
    navigationBar: tabris.NavigationBarProperties & NavigationBarEvents
    navigationView: tabris.NavigationViewProperties & NavigationViewEvents
    page: tabris.PageProperties & PageEvents
    picker: tabris.PickerProperties & PickerEvents
    progressBar: tabris.ProgressBarProperties & ProgressBarEvents
    radioButton: tabris.RadioButtonProperties & RadioButtonEvents
    scrollView: tabris.ScrollViewProperties & ScrollViewEvents
    searchAction: tabris.SearchActionProperties & SearchActionEvents
    slider: tabris.SliderProperties & SliderEvents
    statusBar: tabris.StatusBarProperties & StatusBarEvents
    switch: tabris.SwitchProperties & SwitchEvents
    tab: tabris.TabProperties & TabEvents
    tabFolder: tabris.TabFolderProperties & TabFolderEvents
    textInput: tabris.TextInputProperties & TextInputEvents
    textView: tabris.TextViewProperties & TextViewEvents
    toggleButton: tabris.ToggleButtonProperties & ToggleButtonEvents
    video: tabris.VideoProperties & VideoEvents
    webView: tabris.WebViewProperties & WebViewEvents
    widget: tabris.WidgetProperties & WidgetEvents
    widgetCollection: {}
  }
}